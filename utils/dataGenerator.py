...
class extractPath:
    ...
    def __init__(self) -> None:
        ...
        self.name_mapping.rename({'BraTS_2020_subject_ID': 'Brats20ID'}, axis=1, inplace=True) 
        df = self.survival_info.merge(self.name_mapping, on="Brats20ID", how="right") 
        # print(df.head(10))
...
class generator(Dataset):
    ...
    def preprocess_mask_labels(self, mask: np.ndarray):
        ...
        WT = mask.copy()
        WT[WT == 1] = 1 # eticheta 1 = necrotic / non-enhancing tumor core
        WT[WT == 2] = 1 # eticheta 2 = peritumoral edema
        WT[WT == 4] = 1 # eticheta 4 = enhancing tumor core
